        ...
        >
          <div className="h-full flex flex-col">
            ...
            <nav className={`overflow-y-auto flex-1 text-gray-100 ${sidebarOpen ? 'p-2' : 'p-2 lg:p-1'} space-y-1`}>
              ...
              <SidebarButton collapsed={!sidebarOpen} active={tab === 'search'} onClick={() => handleTabChange('search')} icon={<IconUser />}>
                Search Profiles
              </SidebarButton>
              ...
              <div className={`mt-2 ${sidebarOpen ? 'px-2' : 'px-0'}`}>
                ...
                <SidebarButton collapsed={!sidebarOpen} active={tab === 'summary'} onClick={() => handleTabChange('summary')} icon={<IconChart />}>
                  Attendance Summary
                </SidebarButton>
              </div>
              ...
              <div className={`mt-2 ${sidebarOpen ? 'px-2' : 'px-0'}`}>
                ...
                <SidebarButton collapsed={!sidebarOpen} active={tab === 'approvals'} onClick={() => handleTabChange('approvals')} icon={<IconCheck />}>
                  Leave Approvals
                </SidebarButton>
              </div>
            </nav>
